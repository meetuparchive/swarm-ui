...
const Radio = (props: Props): React.ReactElement<'label'> => {
  ...
  return (
    <label data-swarm-radio={disabled ? 'disabled' : 'default'} htmlFor={id || name} disabled={disabled}>
      ...
      <input type='radio' id={id} name={name} checked={checked} disabled={disabled} value={value} {...other} />
