  ...
  (0, _createClass2["default"])(screenRenderer, [{
    ...
    value: function () {
      ...
      _regenerator["default"].mark(function _callee() {
        var _this$config, host, port, staticPath;

        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$config = this.config, host = _this$config.host, port = _this$config.port, staticPath = _this$config.staticPath;
                _context.next = 3;
    ...
    value: function createRoute(slug, element) {
      ...
      var bodyStyle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      ...
      return {
        ...
        handler: function handler() {
          return "<html>\n\t\t\t\t\t\t\t\t<head>\n\t\t\t\t\t\t\t\t\t".concat(links, "\n\t\t\t\t\t\t\t\t</head>\n\t\t\t\t\t\t\t\t<body style=\"padding: ").concat(_this.config.padding, "; ").concat(bodyStyle, "\">\n\t\t\t\t\t\t\t\t").concat(_server["default"].renderToStaticMarkup(element), "\n\t\t\t\t\t\t\t\t</body>\n\t\t\t\t\t\t\t</html>");
        }
      };
    }
  }, {
